...
//            nodesOfWay = new LinkedList<>();
            isWay = false;
            indexOfNodeThisWay = 0;
            lastWay = new GraphDB.Way(Long.parseLong(attributes.getValue("id")), new HashSet<>());
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            if (indexOfNodeThisWay == 0) {
                idOfLastNodeThisWay = Long.parseLong(attributes.getValue("ref"));
            } else {
                HashSet<Long> connection = new HashSet<Long>();
                connection.add(idOfLastNodeThisWay);
                connection.add(Long.parseLong(attributes.getValue("ref")));
                lastWay.connections.add(connection);
                idOfLastNodeThisWay = Long.parseLong(attributes.getValue("ref"));
            }
            indexOfNodeThisWay += 1;
