...
//        String name;
//
//        Edge(Long id, Long from, Long to) {
//            this.id = id;
//            this.from = from;
//            this.to = to;
//            this.name = null;
...
//    }
        ...
        static class Way {
        Long id;
        HashSet<HashSet<Long>> connections;
        String name;
        String maxSpeed;

        Way(Long id, HashSet<HashSet<Long>> connections) {
            this.id = id;
    ...
    void addWay(Way w) {
        ...
        for (HashSet<Long> connection : w.connections) {
            Queue<Long> connectionCopy = new PriorityQueue<>();
            connectionCopy.addAll(connection);
            addEdge(connectionCopy.poll(), connectionCopy.poll());
        }
